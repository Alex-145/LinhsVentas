    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="space-y-3 mb-6">
            @if (session()->has('message'))
                <div class="p-4 rounded-md bg-green-50 border border-green-200 flex items-start">
            ...
            @if (session()->has('error'))
                <div class="p-4 rounded-md bg-red-50 border border-red-200 flex items-start">
                    ...
                    <div
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900">Eliminar marca</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">
                                            ¿Estás seguro de eliminar la marca <span
                                                class="font-semibold">{{ $brandNameToDelete }}</span>?
                                            @if ($relatedProductsCount > 0)
                                                <br><br>
                                                <span class="text-red-600">Advertencia:</span> Esta marca tiene
                                                {{ $relatedProductsCount }} producto(s) asociado(s).
                                            @endif
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button wire:click="delete" type="button"
                                ...
                                @if ($relatedProductsCount > 0) disabled @endif>
                                Eliminar
                            </button>
                            <button wire:click="resetDeleteConfirmation" type="button"
                            ...
                            <tr class="hover:bg-gray-50 transition duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        @if ($brand->url_imgbrand)
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                    src="{{ asset('storage/' . $brand->url_imgbrand) }}"
                                                    alt="{{ $brand->name }}">
                                            </div>
                                        @endif
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $brand->products_count > 0 ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        <button wire:click="prepareDelete({{ $brand->id }})"
                    ...
                    <div
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900">Cambiar imagen de marca
                                    </h3>
                                    <div class="mt-4">
                                        @if ($url_imgbrand_old)
                                            <div class="mb-4">
                                                <p class="text-sm text-gray-500 mb-2">Imagen actual:</p>
                                                <img src="{{ asset('storage/' . $url_imgbrand_old) }}"
                                                    alt="Imagen actual"
                                                    class="w-32 h-32 object-cover mx-auto rounded">
                                            </div>
                                        @endif
                                        <input type="file" wire:model="url_imgbrand"
