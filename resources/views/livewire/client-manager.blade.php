        ...
        <table class="min-w-full bg-white border border-gray-300 shadow-md rounded-lg overflow-hidden">
            <thead class="bg-gradient-to-r from-indigo-600 to-indigo-800 text-white">
                <tr>
                    ...
                    <th class="py-3 px-4 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">DNI/RUC</th>
                    <th class="py-3 px-4 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">Business Name</th>
                    <th class="py-3 px-4 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">Phone Number</th>
                    <th class="py-3 px-4 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">Actions</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($clients as $client)
                    <tr class="border-b hover:bg-gray-100 transition duration-200">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-800">{{ $client->dni_ruc }}</td>
                        ...
                        <td class="px-4 py-3 text-sm text-gray-800 flex items-center space-x-2">
                            ...
                            <button wire:click="edit({{ $client->id }})"
                                ...
                                <svg class="feather feather-edit w-5 h-5" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
