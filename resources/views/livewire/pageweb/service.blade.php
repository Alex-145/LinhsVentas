<main class="bg-gray-100 py-12">
    <div class="container mx-auto px-4">
        ...
        <section class="text-center mb-16">
            ...
            <p class="text-lg text-gray-600">Ofrecemos soluciones completas para el mantenimiento y cuidado de tus
                llantas.</p>
        </section>
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <img src="{{ asset('storage/pageweb/venta.jpg') }}" alt="Venta de Llantas"
            ...
            <!-- Parchado Vipal -->
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <img src="{{ asset('storage/pageweb/parche.webp') }}" alt="Parchado Vipal"
                    class="w-full h-48 object-cover">
                <div class="p-6">
            ...
            <!-- Cambio de Llantas -->
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <img src="{{ asset('storage/pageweb/cambio.jpeg') }}" alt="Cambio de Llantas"
                    class="w-full h-48 object-cover">
                <div class="p-6">
        ...
        <section class="text-center mt-16">
            ...
            <a href="/wcontactenos"
                class="bg-blue-600 text-white px-6 py-3 rounded-lg shadow hover:bg-blue-700">Contáctanos</a>
        </section>
    </div>
</main>
