...
use App\Livewire\Pageweb\VerificarPedido;
use App\Livewire\PrediccionProducto;
...
Route::get('/verificar-pedido', VerificarPedido::class)->name('verificar.pedido');
...
Route::get('/politica-de-privacidad', function () {
    ...
    return view('policy', ['policy' => new HtmlString($html)]);
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/predicciones', PrediccionProducto::class)->name('predicciones');
    Route::get('/ventas-online', VentasOnline::class)->name('ventas-online.index');
